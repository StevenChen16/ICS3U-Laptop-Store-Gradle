...
public class LaptopStoreResultsFrame extends JFrame implements ActionListener {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LaptopStoreResultsFrame.class);
    ...
    private void updateDisplay() {
        if (recommendedLaptop != null && laptops != null) {
            logger.info("Top 3 recommended laptops indices: " + 
                             recommendedLaptop[0] + ", " + 
                             recommendedLaptop[1] + ", " + 
    ...
    private void updatePanel(JPanel panel, String imagePath) {
        ...
        ImageIcon originalIcon = new ImageIcon(LaptopStoreResultsFrame.class.getClassLoader().getResource(imagePath));
