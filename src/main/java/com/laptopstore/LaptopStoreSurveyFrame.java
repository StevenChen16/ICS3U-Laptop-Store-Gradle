...
public class LaptopStoreSurveyFrame extends JFrame {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LaptopStoreSurveyFrame.class);
    ...
    private Map<String, Set<String>> readDatabase() {
        ...
        try (InputStream inputStream = getClass().getClassLoader().getResourceAsStream("data/database.csv");
    ...
    private void addEventListeners() {
        ...
        continueButton.addActionListener(e -> {
            ...
            for (Map.Entry<String, Object> entry : values.entrySet()) {
                ...
                logger.info(entry.getKey() + ": " + entry.getValue()); // Using SLF4J logger.
            }
            dispose();  // Close Current Window
