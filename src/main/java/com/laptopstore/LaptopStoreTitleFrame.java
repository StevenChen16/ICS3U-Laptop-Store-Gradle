...
public class LaptopStoreTitleFrame extends JFrame implements ActionListener {
    ...
    private ImageIcon originalIcon = new ImageIcon(LaptopStoreTitleFrame.class.getClassLoader().getResource("images/logo.png"));
    ...
    private static final Logger logger = LoggerFactory.getLogger(LaptopStoreTitleFrame.class);
    ...
    private void setupComponents() {
        ...
        Image scaledImage = originalIcon.getImage().getScaledInstance(450, 254, Image.SCALE_SMOOTH);
    ...
    private void finalFrameSetup() {
        ...
        ImageIcon icon = new ImageIcon(LaptopStoreTitleFrame.class.getClassLoader().getResource("images/logo.png"));
